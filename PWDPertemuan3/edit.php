...
//Check if From submitted for user update, then redirect to homepage after update
if (isset($_POST['update'])) {
    ...
    //update user data
    $result = mysqli_query($con, "UPDATE mahasiswa SET nama='$nama',jkel='$jkel',alamat='$alamat',tgllhr='$tgllhr' 
    WHERE nim='$nim'");
